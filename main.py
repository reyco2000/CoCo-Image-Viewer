...
class App(tk.Tk):
    def __init__(self):
        super().__init__()
        self.title("CoCo MAX/CM3/CLP/MGE DSK Viewer")
...
def main():
    parser = argparse.ArgumentParser(description="CoCo MAX/CM3/CLP/MGE DSK Tool")
    ...
    extract_parser = subparsers.add_parser("extract", help="Extract and convert a MAX, CM3, CLP, or MGE file to PNG")
    extract_parser.add_argument("dsk_file", help="Path to the DSK file")
    extract_parser.add_argument("image_file", help="Name of the MAX, CM3, CLP, or MGE file to extract")
